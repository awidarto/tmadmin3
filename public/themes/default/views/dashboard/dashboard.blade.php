            ...
            <div class="row-fluid">
                ...
                <div class="box chat alt span5 noMargin" ontablet="span12" ondesktop="span5">
                    ...
                    <div class="contacts">
                        <ul class="list">
                            <li>
                                <img class="avatar" src="{{ URL::to('sm') }}/img/avatar.jpg" alt="avatar" />
                                <span class="name">Łukasz Holeczek</span>
                                <span class="status online"></span>
                                <span class="important">4</span>
                            </li>
                            <li>
                                <img class="avatar" src="{{ URL::to('sm') }}/img/avatar2.jpg" alt="avatar" />
                                <span class="name">Łukasz Holeczek</span>
                                <span class="status offline"></span>
                            </li>
                            <li>
                                <img class="avatar" src="{{ URL::to('sm') }}/img/avatar3.jpg" alt="avatar" />
                                <span class="name">Łukasz Holeczek</span>
                    ...
                    <div class="conversation">
                        <div class="actions">
                            <img class="avatar" src="{{ URL::to('sm') }}/img/avatar.jpg" alt="avatar" />
                            <img class="avatar" src="{{ URL::to('sm') }}/img/avatar3.jpg" alt="avatar" />
                            <img class="avatar" src="{{ URL::to('sm') }}/img/avatar4.jpg" alt="avatar" />
                        </div>
                        <ul class="talk">
                            <li>
                                <img class="avatar" src="{{ URL::to('sm') }}/img/avatar3.jpg" alt="avatar" />
            ...
            <div class="row-fluid">
                ...
                <div class="span12 discussions">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="author">
                                <img src="{{ URL::to('sm') }}/img/avatar.jpg" alt="avatar" />
                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="author">
                                        <img src="{{ URL::to('sm') }}/img/avatar3.jpg" alt="avatar" />
                                    </div>
                                ...
                                <li>
                                    <div class="author">
                                        <img src="{{ URL::to('sm') }}/img/avatar6.jpg" alt="avatar" />
                                    </div>
                        ...
                        <li>
                            <div class="author">
                                <img src="{{ URL::to('sm') }}/img/avatar9.jpg" alt="avatar" />
                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="author">
                                        <img src="{{ URL::to('sm') }}/img/avatar2.jpg" alt="avatar" />
                                    </div>
                                ...
                                <li>
                                    <div class="author">
                                        <img src="{{ URL::to('sm') }}/img/avatar4.jpg" alt="avatar" />
                                    </div>
