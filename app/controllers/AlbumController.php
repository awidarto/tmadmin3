...
class AlbumController extends AdminController {
    ...
    public function getIndex()
    {
        ...
        $this->heads = array(
            array('Album',array('search'=>true,'sort'=>true)),
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            array('albumName',array('kind'=>'text','query'=>'like','pos'=>'both','show'=>true)),
    ...
    public function makeActions($data)
    {
        ...
        $edit = '<a href="'.URL::to('music/edit/'.$data['_id']).'"><i class="fa fa-edit"></i>Update</a>';
